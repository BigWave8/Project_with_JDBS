...
VALUES ('Carole', 'Duarte', 'Turner', '(228)323-4772', '688322',
       ...
       ('Eduardo', 'Greer', 'Elliott', '(786)258-1550', '779930',
        'Decimal Fraction Generator makes numbers in the [0,1] range with configurable decimal places', '8'),
       ('Ruby-May', 'Osborne', NULL, '(601)844-4538', '271342',
        'Password Generator makes secure passwords for your Wi-Fi or that extra Gmail account', '14'),
       ('Dianne', 'Thompson', NULL, '(619)377-5644', '458881', 'Bitmaps in black and white', '7'),
       ('Carmel', 'Hilton', 'Hale', '(320)745-4778', '375235', 'Samuel Becketts randomly generated short prose', '9');

INSERT INTO apartament(area, adress, ceiling_high, room_number, recomended_people_count, price, lessor_id)
...
VALUES ('1', '1', 'Pure White Audio Noise for composition or just to test your audio equipment', '12'),
       ('4', '1', 'Samuel Becketts randomly generated short prose', '11'),
       ('8', '1', 'Many Testimonials from folks who have found very creative uses for random numbers', '9'),
